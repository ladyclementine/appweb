...
class InternshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create internship" do
    assert_difference('Internship.count') do
      post internships_url, params: { internship: { cash: @internship.cash, company: @internship.company, description: @internship.description, duration: @internship.duration, office: @internship.office } }
    end
  ...
  test "should update internship" do
    patch internship_url(@internship), params: { internship: { cash: @internship.cash, company: @internship.company, description: @internship.description, duration: @internship.duration, office: @internship.office } }
